...
public class ExpiredOtpCleanupWorkerFixture : PotFixtureBase
{
    ...
    public class Constructor : ExpiredOtpCleanupWorkerFixture
    {
    ...
    public class ExecuteAsync : ExpiredOtpCleanupWorkerFixture
    {
        [Fact]
    ...
    private static ExpiredOtpCleanupWorker CreateWorker(IHostApplicationLifetime applicationLifetime, ITimeProvider timeProvider,
        IServiceScopeFactory scopeFactory, IServiceHealthPoller serviceHealthPoller)
    {
        return new ExpiredOtpCleanupWorker(applicationLifetime, timeProvider, scopeFactory, serviceHealthPoller);
    }
}
