...
using Pot.AspNetCore.Features.Expenses.Update;
using Pot.Shared.Enumerations;
using Shouldly;

namespace Pot.AspNetCore.Tests.Features.Expenses.Update;
...
public class RequestValidatorFixture
{
    ...
    [Fact]
    public void Should_Return_Error_When_ExcludeFromCalcs_Is_Null()
    {
        var request = CreateRequest(excludeFromCalcs: null);

        var validationResult = Validate(request);

        ShouldContainError(validationResult, nameof(Request.ExcludeFromCalcs));
    }
