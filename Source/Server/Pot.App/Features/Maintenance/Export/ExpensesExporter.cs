...
internal sealed class ExpensesExporter : MemoryCsvExporterBase<ExpenseData>, IExpensesExporter
{
    ...
    protected override ICsvSerializer<ExpenseData> CreateSerializer(IEnumerable<ExpenseData>? configData = null)
    {
        ...
        serializer.AddField(nameof(ExpenseData.AccrualStart), entity => entity.AccrualStart);
        serializer.AddField(nameof(ExpenseData.NextDue), entity => entity.NextDue);
        serializer.AddField(nameof(ExpenseData.EndDate), entity => entity.EndDate);
