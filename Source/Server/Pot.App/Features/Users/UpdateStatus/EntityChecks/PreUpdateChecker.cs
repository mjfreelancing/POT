...
using Pot.App.Features.Users.UpdateStatus.EntityChecks.Checks;
...
internal sealed class PreUpdateChecker : ChainOfResponsibilityAsyncComposer<InputState, ProblemDetailsError>, IPreUpdateChecker
{
    ...
    public Task<ProblemDetailsError?> CanSaveAsync(Input input, UserEntity userToUpdate, CancellationToken cancellationToken)
    {
