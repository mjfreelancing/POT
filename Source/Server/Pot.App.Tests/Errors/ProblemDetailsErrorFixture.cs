...
public class ProblemDetailsErrorFixture : PotFixtureBase
{
    public class Constructor : ProblemDetailsErrorFixture
    {
        [Fact]
        public void Should_Set_ErrorType_To_Match_ProblemType()
        {
            ...
            var error = new ProblemDetailsError(problemType)
            {
                ErrorCode = "TestCode",
