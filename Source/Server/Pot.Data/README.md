...
dotnet ef migrations add MigrationName --project Pot.Data --startup-project Pot.Data
- `--project` specifies the migrations project (Pot.Data).
- `--startup-project` should also be set to Pot.Data.
...
Add-Migration MigrationName -StartupProject Pot.Data
...
Update-Database -StartupProject Pot.Data
